...
#define WINED3D_SHADER_CONST_VS_CLIPPLANES   0x00000008
#define WINED3D_SHADER_CONST_VS_POINTSIZE    0x00000010
#define WINED3D_SHADER_CONST_VS_POS_FIXUP    0x00000020
...
#define WINED3D_SHADER_CONST_PS_ALPHA_TEST   0x00002000
...
struct ps_compile_args {
    ...
    WORD alpha_func; /* A WORD is enough to store the GL value, could be squeezed further if necessary. */
    WORD alpha_override; /* MAX_FRAGMENT_SAMPLERS, 16 */
...
struct vs_compile_args
{
    ...
    BYTE flatshading : 1;
    BYTE alpha_override : 4; /* MAX_VERTEX_SAMPLERS, 4 */
...
/* 8 texcoords + diffuse and specular color. */
#define WINED3D_FFP_MAX_VARYINGS 10
...
extern const struct wined3d_vertex_pipe_ops glsl_vp_core DECLSPEC_HIDDEN;
...
extern const struct blit_shader glsl_blit DECLSPEC_HIDDEN;
...
struct ffp_frag_settings
{
    ...
    WORD alpha_func; /* a WORD is enough to store the GL value as-is (could be shrunk further if need be). */
    WORD alpha_override; /* MAX_TEXTURES = 8, going for the WORD to ensure DWORD alignment. */
};
...
HRESULT wined3d_sub_resource_map(struct wined3d_resource *resource, struct wined3d_map_desc *map_desc,
...
HRESULT wined3d_sub_resource_unmap(struct wined3d_resource *resource) DECLSPEC_HIDDEN;
...
#define WINED3DFMT_FLAG_ALPHA_OVERRIDE              0x00200000
