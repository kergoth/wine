 ...
 *                              handle_drv_open
 */
static LRESULT handle_drv_open(LPSTR str, DWORD index)
{
 ...
 *                              handle_drv_close
 */
static LRESULT handle_drv_close(DWORD_PTR device_id)
{
 ...
 *                              mac_joyGetDevCaps
 */
static LRESULT mac_joyGetDevCaps(DWORD_PTR device_id, JOYCAPSW* caps, DWORD size)
{
    joystick_t* joystick;
 ...
 *                              mac_joyGetPosEx
 */
static LRESULT mac_joyGetPosEx(DWORD_PTR device_id, JOYINFOEX* info)
{
    static const struct {
        DWORD flag;
        off_t offset;
 ...
 *                              mac_joyGetPos
 */
static LRESULT mac_joyGetPos(DWORD_PTR device_id, JOYINFO* info)
{
    JOYINFOEX ji;
    LONG ret;
    ...
    ret = mac_joyGetPosEx(device_id, &ji);
 ...
 *                              DriverProc (JOYSTICK.@)
 */
LRESULT CALLBACK DriverProc(DWORD_PTR device_id, HDRVR driver, UINT msg, LPARAM param1, LPARAM param2)
{
    switch (msg)
    {
        case DRV_LOAD:              return 1;
        case DRV_FREE:              return 1;
        case DRV_OPEN:              return handle_drv_open((LPSTR)param1, param2);
        case DRV_CLOSE:             return handle_drv_close(device_id);
        case DRV_ENABLE:            return 1;
        case DRV_DISABLE:           return 1;
        case DRV_QUERYCONFIGURE:    return 1;
        case DRV_CONFIGURE:         MessageBoxA(0, "JoyStick MultiMedia Driver!", "JoyStick Driver", MB_OK);
                                    return 1;
        case DRV_INSTALL:           return DRVCNF_RESTART;
        case DRV_REMOVE:            return DRVCNF_RESTART;

        case JDD_GETNUMDEVS:        return 1;
        case JDD_GETDEVCAPS:        return mac_joyGetDevCaps(device_id, (JOYCAPSW*)param1, param2);
        case JDD_GETPOS:            return mac_joyGetPos(device_id, (JOYINFO*)param1);
        case JDD_SETCALIBRATION:
        case JDD_CONFIGCHANGED:     return JOYERR_NOCANDO;
        case JDD_GETPOSEX:          return mac_joyGetPosEx(device_id, (JOYINFOEX*)param1);
    }

    return DefDriverProc(device_id, driver, msg, param1, param2);
}
